    ...
    public class PositionPlane : HandleBase
    {
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            Vector3 rperp = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.TargetTransform.rotation * _perp
                : _perp;

            _plane = new Plane(rperp, _parentTransformHandle.TargetTransform.position);
        ...
        void Update()
        {
            ...
            Vector3 raxis1 = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.TargetTransform.rotation * axis1
                : axis1;
            float angle1 = Vector3.Angle(_parentTransformHandle.CurrentCamera.transform.forward, raxis1);
            if (angle1 < 90)
                axis1 = -axis1;
            ...
            Vector3 raxis2 = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.TargetTransform.rotation * axis2
                : axis2;
            float angle2 = Vector3.Angle(_parentTransformHandle.CurrentCamera.transform.forward, raxis2);
            if (angle2 < 90)
                axis2 = -axis2;
